...
const InstituteDetail = () => {
  ...
  const config = {
    ...
    formFields: [
      ...
      { id: 'name', type: 'text', label: '이름', dataProperty: ['name'] },
      { id: 'institute', type: 'institute', label: '단체명', dataProperty: ['institute', 'title'] },
      { id: 'instituteId', type: 'hidden', dataProperty: ['institute', 'id'] },
      { id: 'type', type: 'select', option: ['admin','단체장','선수','심판'], label: '사용자구분', dataProperty: ['type'] },
      { id: 'email', type: 'email', label: '이메일', dataProperty: ['email'] },
      { id: 'contact', type: 'text', label: '연락처', dataProperty: ['contact'] },
    ],
